...
Add references to \texttt{paper/references.bib} and cite them with \texttt{\textbackslash cite\{key\}}. Prefer primary sources for algorithms, standards, protocols, datasets, and tools. For example, cite the original paper for a method, the official standard for a technical specification, and the project documentation for a software dependency. This keeps the bibliography defensible and avoids relying on secondary summaries for technical claims.
