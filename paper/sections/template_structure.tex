...
\texttt{images/} & Optional figure and signature assets. \\
...
The main document imports packages that are commonly useful in cryptography papers. The \texttt{amsmath} packages support mathematical notation, \texttt{algorithm} and \texttt{algpseudocode} support pseudocode, \texttt{booktabs} supports clean tables, and \texttt{hyperref} provides link handling. The template also demonstrates how to include repository images using paths relative to \texttt{paper/main.tex}.
